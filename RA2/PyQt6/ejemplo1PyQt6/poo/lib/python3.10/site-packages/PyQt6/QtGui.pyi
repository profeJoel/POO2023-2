...
class QAction(QtCore.QObject):
    ...
    @typing.overload
    def setShortcuts(self, shortcuts: typing.Iterable[typing.Union['QKeySequence', 'QKeySequence.StandardKey', typing.Optional[str], int]]) -> None: ...
    @typing.overload
...
class QGradient(PyQt6.sip.simplewrapper):
    ...
    def setStops(self, stops: typing.Iterable[typing.Tuple[float, typing.Union[QColor, QtCore.Qt.GlobalColor, int]]]) -> None: ...
...
class QFont(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, families: typing.Iterable[typing.Optional[str]], pointSize: int = ..., weight: int = ..., italic: bool = ...) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def stringToTag(tagString: typing.Optional[bytes]) -> int: ...
    @staticmethod
    def tagToString(tag: int) -> QtCore.QByteArray: ...
    def clearFeatures(self) -> None: ...
    def featureTags(self) -> typing.List[int]: ...
    def isFeatureSet(self, tag: int) -> bool: ...
    def featureValue(self, tag: int) -> int: ...
    @typing.overload
    def unsetFeature(self, feature: typing.Optional[bytes]) -> None: ...
    @typing.overload
    def unsetFeature(self, tag: int) -> None: ...
    @typing.overload
    def setFeature(self, tag: int, value: int) -> None: ...
    @typing.overload
    def setFeature(self, feature: typing.Optional[bytes], value: int) -> None: ...
...
class QFontDatabase(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def smoothSizes(family: typing.Optional[str], style: typing.Optional[str]) -> typing.List[int]: ...
    @staticmethod
    def pointSizes(family: typing.Optional[str], style: typing.Optional[str] = ...) -> typing.List[int]: ...
    @staticmethod
    def styles(family: typing.Optional[str]) -> typing.List[str]: ...
    @staticmethod
    def families(writingSystem: 'QFontDatabase.WritingSystem' = ...) -> typing.List[str]: ...
    @typing.overload
    @staticmethod
    def writingSystems(family: typing.Optional[str]) -> typing.List['QFontDatabase.WritingSystem']: ...
    @typing.overload
    @staticmethod
...
class QImageReader(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def imageFormatsForMimeType(mimeType: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]) -> typing.List[QtCore.QByteArray]: ...
...
class QShortcut(QtCore.QObject):
    ...
    @typing.overload
    def setKeys(self, keys: typing.Iterable[typing.Union[QKeySequence, QKeySequence.StandardKey, typing.Optional[str], int]]) -> None: ...
    @typing.overload
...
class QStandardItemModel(QtCore.QAbstractItemModel):
    ...
    def setItemRoleNames(self, roleNames: typing.Dict[int, typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]]) -> None: ...
    def dropMimeData(self, data: typing.Optional[QtCore.QMimeData], action: QtCore.Qt.DropAction, row: int, column: int, parent: QtCore.QModelIndex) -> bool: ...
    def mimeData(self, indexes: typing.Iterable[QtCore.QModelIndex]) -> typing.Optional[QtCore.QMimeData]: ...
    def mimeTypes(self) -> typing.List[str]: ...
    def setSortRole(self, role: int) -> None: ...
    def sortRole(self) -> int: ...
    def findItems(self, text: typing.Optional[str], flags: QtCore.Qt.MatchFlag = ..., column: int = ...) -> typing.List['QStandardItem']: ...
...
class QTextLayout(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def glyphRuns(self, from_: int, length: int, flags: 'QTextLayout.GlyphRunRetrievalFlag') -> typing.List[QGlyphRun]: ...
    ...
    def draw(self, p: typing.Optional[QPainter], pos: QtCore.QPointF, selections: typing.Iterable['QTextLayout.FormatRange'] = ..., clip: QtCore.QRectF = ...) -> None: ...
...
class QUtiMimeConverter(PyQt6.sip.simplewrapper):

    def __init__(self) -> None: ...

    def count(self, mimeData: typing.Optional[QtCore.QMimeData]) -> int: ...
    def convertToMime(self, mime: typing.Optional[str], data: typing.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]], uti: typing.Optional[str]) -> typing.Any: ...
    def mimeForUti(self, uti: typing.Optional[str]) -> str: ...
    def utiForMime(self, mime: typing.Optional[str]) -> str: ...
    def convertFromMime(self, mime: typing.Optional[str], data: typing.Any, uti: typing.Optional[str]) -> typing.List[QtCore.QByteArray]: ...
    def canConvert(self, mime: typing.Optional[str], uti: typing.Optional[str]) -> bool: ...
